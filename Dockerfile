...
ARG IMAGE_COMPONENT="memcached-operator-container"
ARG IMAGE_NAME="memcached-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Memcached Operator"
ARG IMAGE_DESC="This image includes the memcached-operator"
...
ENV USER_UID=$USER_ID \
    OPERATOR_TEMPLATES=/usr/share/memcached-operator/templates/ \
